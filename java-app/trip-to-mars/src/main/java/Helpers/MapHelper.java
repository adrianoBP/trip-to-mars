...
public class MapHelper {
    ...
    public static NodeCollection buildMap() throws Exception {
        ...
        String s2 = nodeCollection.insertNode(new Node("Take off", "And it's take off! You just started your new adventure"));
        String s3 = nodeCollection.insertNode(new Node("Incident in orbit", "Something is not quite right - The ship trembles a bit more than expected"));
        ...
        String s37 = nodeCollection.insertNode(new Node("Meteors!", "While waiting for the call to connect, you notice from one of the windows that a few meteors are starting to fall down but they are still quite far - Is it safe for your team?"));
        ...
        String e14 = nodeCollection.insertNode(new Node("You die", "The spaceship pipes erupted and caused the vehicle to explode"));
