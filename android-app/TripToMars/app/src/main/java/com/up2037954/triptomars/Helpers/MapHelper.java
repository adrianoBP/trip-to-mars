...
public class MapHelper {
    ...
    public static NodeCollection buildMap(Context context) throws Exception {
        ...
        String e1 = nodeCollection.insertNode(new Node("You live", "The systems were right! You get back safely into the Earth's atmosphere and splash into the ocean! You are home.", "", "confetti"));
        ...
        String s7 = nodeCollection.insertNode(new Node("The pen", "The pen from your boss is the exact size of the hole and could be a temporary fix", "", "pen"));
        ...
        String s11 = nodeCollection.insertNode(new Node("Land on Mars", "You made it! You finally landed on the red planet.. but now there's a lot of pressure! Who will be the first to put foot on the new planet? Will you push to be the first or will you follow the procedures?", "", "mars"));
        String u10 = nodeCollection.insertNode(new Node("Push", ""));
        String u11 = nodeCollection.insertNode(new Node("Follow procedures", ""));
        String c4 = nodeCollection.insertNode(new Node("You tripped", "In the rush to get out you trip over a step!", "", "alert", 1));
        ...
        String e8 = nodeCollection.insertNode(new Node("You live", "You and your team decide to join the secret mission - Is this already a new beginning?", "", "confetti"));
        ...
        String e15 = nodeCollection.insertNode(new Node("You live", "After many days in orbit, you get back to Earth safely, ready to tell many, many stories", "", "confetti"));
        ...
        String e17 = nodeCollection.insertNode(new Node("You live", "You now have all the components to start building the most critical components for a lab and a very small camp! Here you will start a new whole story!", "", "confetti"));
        ...
        String e20 = nodeCollection.insertNode(new Node("You live", "You now have all the components and you had back to the ship - You can finally fix the broken parts to head home!", "", "confetti"));
...
//        String t0 = nodeCollection.insertNode(new Node("TEST", "TEST"));
    ...
    public static MapValidationData validateMapPath(NodeCollection nodeCollection) throws Exception {
        ...
        // Make sure we have a starting node
        if (TextUtils.isEmpty(startingNodeId))
